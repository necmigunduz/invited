  ...
  return (
    <div className="my-8 flex flex-col justify-center items-center">
      <div className="text-center my-8 leading-none">
        <p className="text-[105px] text-cyan-900 font-bold tracking-tighter">
          Imagine if
        </p>
        <p className="text-[105px] font-bold text-cyan-600 tracking-tighter">
          Snapchat
        </p>
        <p className="text-[105px] text-cyan-900 font-bold tracking-tighter">
          had events.
      ...
      <div className="my-8">
        <p className="text-slate-700 font-light text-[38px] w-[800px] text-center">
      ...
      <div>
        <Link to="/create">
          <Button
            ...
            iconName={solid("champagne-glasses")}
            classes={btn2style}
          />
        </Link>
      </div>
